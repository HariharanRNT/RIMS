    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MonthlyReportLogs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SupportActivityTypes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductClientMappings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductClientMappings_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProductClientMappings_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RefTable = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ActivityTimelines_Employees_EmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkLocation = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GraceTimeViolations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GraceTimeViolations_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Month = table.Column<int>(type: "int", nullable: false),
                    Year = table.Column<int>(type: "int", nullable: false),
                    LOPDays = table.Column<decimal>(type: "decimal(4,2)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LOPCalculations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LOPCalculations_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PermissionsUsed = table.Column<int>(type: "int", nullable: false),
                    GraceViolations = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<int>(type: "int", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HeldTaskId = table.Column<int>(type: "int", nullable: true),
                    StartTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EndTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BreakLogs_BreakTypes_BreakTypeId",
                        column: x => x.BreakTypeId,
                        principalTable: "BreakTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BreakLogs_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BreakLogs_Tasks_HeldTaskId",
                        column: x => x.HeldTaskId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SupportActivityLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SupportActivityLogs_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SupportActivityLogs_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SupportActivityLogs_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SupportActivityLogs_SupportActivityTypes_ActivityTypeId",
                        column: x => x.ActivityTypeId,
                        principalTable: "SupportActivityTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SupportActivityLogs_Tasks_HeldTaskId",
                        column: x => x.HeldTaskId,
                        principalTable: "Tasks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActivityTimeline_EmployeeId_StartTime",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendanceLog_EmployeeId_LoginTime",
                table: "AttendanceLogs",
                columns: new[] { "EmployeeId", "LoginTime" });

            migrationBuilder.CreateIndex(
                name: "IX_BreakLogs_BreakTypeId",
                table: "BreakLogs",
                column: "BreakTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_BreakLogs_EmployeeId",
                table: "BreakLogs",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_BreakLogs_HeldTaskId",
                table: "BreakLogs",
                column: "HeldTaskId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Client_GSTNo",
                table: "Clients",
                column: "GSTNo",
                unique: true,
                filter: "[GSTNo] IS NOT NULL AND [IsActive] = 1");
            ...
            migrationBuilder.CreateIndex(
                ...
                column: "CIN",
                unique: true,
                filter: "[CIN] IS NOT NULL AND [IsActive] = 1");
            ...
            migrationBuilder.CreateIndex(
                ...
                column: "PAN",
                unique: true,
                filter: "[PAN] IS NOT NULL AND [IsActive] = 1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Employee_ReportingPersonId",
                table: "Employees",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeWorkDetail_EmployeeId",
                table: "EmployeeWorkDetails",
                column: "EmployeeId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_GraceTimeViolation_EmployeeId_Date",
                table: "GraceTimeViolations",
            ...
            migrationBuilder.CreateIndex(
                name: "UQ_LOP_Employee_Month_Reason",
                table: "LOPCalculations",
                columns: new[] { "EmployeeId", "Month", "Year", "Reason" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductClientMappings_ClientId",
                table: "ProductClientMappings",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "UQ_Product_Client",
                table: "ProductClientMappings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SupportActivityLogs_ActivityTypeId",
                table: "SupportActivityLogs",
                column: "ActivityTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_SupportActivityLogs_ClientId",
                table: "SupportActivityLogs",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_SupportActivityLogs_EmployeeId",
                table: "SupportActivityLogs",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_SupportActivityLogs_HeldTaskId",
                table: "SupportActivityLogs",
                column: "HeldTaskId");

            migrationBuilder.CreateIndex(
                name: "IX_SupportActivityLogs_ProductId",
                table: "SupportActivityLogs",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_SupportActivityTypes_Name",
                table: "SupportActivityTypes",
                column: "Name",
                unique: true,
                filter: "[IsActive] = 1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Task_EmployeeId_Status",
                table: "Tasks",
